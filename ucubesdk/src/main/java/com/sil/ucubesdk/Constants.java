...
final class Constants {
    static final String CONTEXT_ERROR_MSG = "Context Cannot be null";
    static final String KEY_ERROR = "Key Cannot be null or Empty";
    static final String PACKAGE_NAME_ERROR = "Package Name Error. Contact Developer";
    static final String REQUEST_ERROR = "UCubeRequest params cannot be empty";
    static final String INITIATE_TRANSACTION_ERROR = "Error occured while initiating Transaction. Contact Developer";
    static final String PACKAGE_INVALID = "The SDK cannot be integrated with your project. Contact Developer";
    static final String NETWORK_EXCEPTION = "Server is down. Try again later";
    static final String VALIDATE_REQUEST_CODE = "validateSdk";

    static final String BLUETOOTH_MAC_ADDRESS = "BT_deviceMacAddr";
    static final String BLUETOOTH_DEVICE_NAME = "BT_deviceName";
    static final String MDM_SERVER_URL = "MDM.serverUrl";
    static final String NFC_ENABLED_DEVICE = "NFC_enabled_device";
    static final String MDM_SERIAL_NUMBER = "MDM.deviceSerial";
    static final String MDM_DEVICE_PART_NUMBER = "MDM.devicePartNUmber";
    static final String LOG_MANAGER_STATE = "LogManager.state";

    static final int PACKAGE_NAME_ERROR_CODE = 201;

    static final int REQUEST_ERROR_CODE = 202;
    static final int CONTEXT_ERROR_CODE = 203;
    static final int KEY_ERROR_CODE = 204;
    static final int PACKAGE_INVALID_CODE = 205;
    static final int NETWORK_EXCEPTION_CODE = 207;
    static final int TRANSACTION_ID_MISSING_CODE = 206;
    static final int UNKOWN_ERROR = 109;



  /*  static final String SDK_ENQUIRY = "sdkenquiry";
    static final String SDK_WITHDRAW = "sdkwithdraw";
    static final String SDK_SALE = "sdksale";
    static final String TRANSACTION_STATUS = "sdkTxnStatus";
    */

    static final String SDK_ENQUIRY = "sdkenquiryIcici";
    static final String SDK_WITHDRAW = "sdkwithdrawIcici";
    static final String SDK_SALE = "sdksale";
    static final String TRANSACTION_STATUS = "sdkTxnStatusIcici";

    static final String TRANSACTION_WITHDRAW = "withdraw";
    static final String TRANSACTION_SALE = "sale";
